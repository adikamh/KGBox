...
class UsernameService {
  ...
  Future<bool> isUsernameAvailable(String username) async {
    try {
      ...
      // untuk hapus kaya username nya udh ada
      return false;
    }
  }
  ...
  static bool isValidUsername(String username) {
    // Hanya huruf, angka, underscore, titik gausah tambahin yang aneh aneh
  ...
  static List<String> suggestUsernames(String baseUsername) {
    ...
    suggestions.add(
      '${baseUsername}_${now.millisecondsSinceEpoch.toString().substring(8)}',
    );
